...
<html style="font-size: 16px;" lang="en"><head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="Composer profile">
    <meta name="description" content="">
    <title>Composer_profile</title>
    <link rel="stylesheet" href="nicepage.css" media="screen">
<link rel="stylesheet" href="Composer_profile.css" media="screen">
    ...
    <meta name="twitter:title" content="Composer_profile">
    <meta name="twitter:description" content="corelia_project">
    <meta property="og:title" content="Composer_profile">
  ...
  <body class="u-body u-xl-mode" data-lang="en"><header class="u-clearfix u-header u-header" id="sec-eb68"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-section-1" id="sec-3a0a">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <h1 class="u-text u-text-default u-text-1">Composer profile</h1>
        <p class="u-text u-text-2">
        The composer profile page is where you can briefly view the profiles of female 
        composers with their photos and each composer's information such as data of birth, nationality, biography, score link ,and recoding links.
        </p>
                ...
                echo "<a href ='addComposer.php' style='float: right; padding-right: 20px; padding: 5px;'>Add New composer or work data </a>";
                }
                else{
                  echo ""; 
                }}
...
<?php
        ...
        //while ($composerMaxID) {
          echo "<div class='row'>";
                ...
                $secondString = "select name, id from composer where id = 136";
                ...
                while ($row) {
                    ...
                    echo " <a href='Profile_detail.php?id=$row[1]' ><img src='images/Alice_Mary_Smith.png' alt='HTML tutorial' style='width:360px;height:220px;'></a>";
                    echo "<a href='Profile_detail.php?id=$row[1]' ><h3 class='u-text u-text-default u-text-2'>$row[0]</h3></a>";
                    echo "</div>";
                    $row = mysqli_fetch_row($secondResult);
            }
            $thirdString = "select name, id from composer where id = 105";
            ...
            while ($row) {
                echo "<div class='column'>";
                echo " <a href='Profile_detail.php?id=$row[1]' ><img src='images/elisabethlutyens-Copy.jpg' alt='HTML tutorial' style='width:360px;height:220px;'></a>";
                echo "<a href='Profile_detail.php?id=$row[1]' ><h3 class='u-text u-text-default u-text-2'>$row[0]</h3></a>";
                echo "</div>";
                $row = mysqli_fetch_row($secondResult);
        }
        $forthString = "select name, id from composer where id = 38";
            $secondResult = @mysqli_query($DBConnect , $forthString)
            Or die ("<p>Unable to query the table.</p>"."<p>Error code ".mysqli_errno($DBConnect). ": ".mysqli_error($DBConnect))."</p>";
            ...
            while ($row) {
                echo "<div class='column'>";
                echo " <a href='Profile_detail.php?id=$row[1]' ><img src='images/anncleare.jpg' alt='HTML tutorial' style='width:360px;height:220px;'></a>";
                echo "<a href='Profile_detail.php?id=$row[1]' ><h3 class='u-text u-text-default u-text-2'>$row[0]</h3></a>";
                echo "</div>";
                $row = mysqli_fetch_row($secondResult);
        }
        
        $fString = "select name, id from composer where id = 116";
        $secondResult = @mysqli_query($DBConnect , $fString)
        Or die ("<p>Unable to query the table.</p>"."<p>Error code ".mysqli_errno($DBConnect). ": ".mysqli_error($DBConnect))."</p>";
        ...
        while ($row) {
            echo "<div class='column'>";
            echo " <a href='Profile_detail.php?id=$row[1]' ><img src='images/Ailis-Ni-Riain-.jpg' alt='HTML tutorial' style='width:360px;height:220px;'></a>";
            echo "<a href='Profile_detail.php?id=$row[1]' ><h3 class='u-text u-text-default u-text-2'>$row[0]</h3></a>";
            echo "</div>";
            $row = mysqli_fetch_row($secondResult);
    }
          $sString = "select name, id from composer where id = 92";
          $secondResult = @mysqli_query($DBConnect , $sString)
          Or die ("<p>Unable to query the table.</p>"."<p>Error code ".mysqli_errno($DBConnect). ": ".mysqli_error($DBConnect))."</p>";
          ...
          while ($row) {
              echo "<div class='column'>";
              echo " <a href='Profile_detail.php?id=$row[1]' ><img src='images/mary-kouyoumdjian.jpg' alt='HTML tutorial' style='width:360px;height:220px;'></a>";
              echo "<a href='Profile_detail.php?id=$row[1]' ><h3 class='u-text u-text-default u-text-2'>$row[0]</h3></a>";
              echo "</div>";
              $row = mysqli_fetch_row($secondResult);
      }
      $vString = "select name, id from composer where id = 128";
      $secondResult = @mysqli_query($DBConnect , $vString)
      Or die ("<p>Unable to query the table.</p>"."<p>Error code ".mysqli_errno($DBConnect). ": ".mysqli_error($DBConnect))."</p>";
      ...
      while ($row) {
          echo "<div class='column'>";
          echo " <a href='Profile_detail.php?id=$row[1]' ><img src='images/RhianSamuel.png' alt='HTML tutorial' style='width:360px;height:220px;'></a>";
          echo "<a href='Profile_detail.php?id=$row[1]' ><h3 class='u-text u-text-default u-text-2'>$row[0]</h3></a>";
          echo "</div>";
          $row = mysqli_fetch_row($secondResult);
  }
...
<input type=button name=type id='bt1' value='Check more composers profile' onclick="setVisibility('myDIV');";> 
</div>
...
if(document.getElementById('bt1').value=='Check more composers profile'){
  document.getElementById('bt1').value = 'Hide other composer profile';
document.getElementById(id).style.display = 'inline';

}else{
  document.getElementById('bt1').value = 'Check more composers profile';
...
<?php
        ...
        //while ($composerMaxID) {
          echo "<div id ='row 'class='row'>";
            for ($i=0; $i<$composerMaxID;$i++){
                $secondString = "select name, id from composer where id = $i";
                ...
                while ($row) {
                    echo "<div class='column'>";
                    echo " <a href='Profile_detail.php?id=$row[1]' ><img src='images/Corelia Project_Master Logo_Black_JPG.jpg' alt='HTML tutorial' style='width:300px;height:170px;'></a>";
                    echo "<a href='Profile_detail.php?id=$row[1]' ><h3 class='u-text u-text-default u-text-2'>$row[0]</h3></a>";
                    echo "</div>";
                    $row = mysqli_fetch_row($secondResult);
            }
