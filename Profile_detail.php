...
<link rel="stylesheet" href="Profile_detail.css" media="screen">
    ...
    <meta name="twitter:title" content="Profile_detail">
    <meta name="twitter:description" content="corelia_project">
    <meta property="og:title" content="Profile_detail">
  ...
  <body class="u-body u-xl-mode" data-lang="en"><header class="u-clearfix u-header u-header" id="sec-eb68"><div class="u-clearfix u-sheet u-sheet-1">
        ...
        <a href="register_form.php" class="u-border-2 u-border-active-palette-2-dark-1 u-border-hover-palette-2-base u-border-palette-1-base u-btn u-button-style u-none u-text-hover-palette-2-base u-text-palette-1-base u-btn-1" > <br> </a>
        <a href="login_form.php"  class="u-border-2 u-border-active-palette-2-dark-1 u-border-hover-palette-2-base u-border-palette-1-base u-btn u-button-style u-none u-text-hover-palette-2-base u-text-palette-1-base u-btn-2"> Login </a>
        ...
        <nav class="u-menu u-menu-one-level u-offcanvas u-menu-1">
          ...
          </li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-custom-color-1 u-text-hover-palette-2-base" style="padding: 10px 20px;">Repository list</a>
          ...
          </li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-custom-color-1 u-text-hover-palette-2-base" style="padding: 10px 20px;">Blog</a>
          </li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-custom-color-1 u-text-hover-palette-2-base" style="padding: 10px 20px;">Forum</a>
          ...
          <div class="u-custom-menu u-nav-container-collapse">
            <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
              <div class="u-inner-container-layout u-sidenav-overflow">
                ...
                </li><li class="u-nav-item"><a class="u-button-style u-nav-link">Repository list</a>
                ...
                </li><li class="u-nav-item"><a class="u-button-style u-nav-link">Forum</a>
...
<section class="u-clearfix u-section-1" id="carousel_3fd0">
        ...
        <div class="u-expanded-width-lg u-expanded-width-md u-expanded-width-sm u-expanded-width-xs u-list u-list-1">
          <div class="u-repeater u-repeater-1">
            <div class="u-container-style u-custom-item u-grey-5 u-list-item u-repeater-item u-shape-rectangle u-list-item-1">
              ...
              $SQLstring = "select name, birth_death_date,nationality_id_1 from composer where id = $composerID ";
              ...
              $SQLstring = "select nationality from nationality where id = $nationality ";
              $queryResult = @mysqli_query($DBConnect , $SQLstring)
              Or die ("<p>Unable to query the table.</p>"."<p>Error code ".mysqli_errno($DBConnect). ": ".mysqli_error($DBConnect))."</p>";
              $row = mysqli_fetch_row($queryResult);
              echo "<h6 class='u-text u-text-default u-text-1'>Nationality: $row[0]</h6>";
              }

              $SQLstring = "select biography from composer where id = $composerID ";
              $queryResult = @mysqli_query($DBConnect , $SQLstring)
              Or die ("<p>Unable to query the table.</p>"."<p>Error code ".mysqli_errno($DBConnect). ": ".mysqli_error($DBConnect))."</p>";
              $row = mysqli_fetch_row($queryResult);
              echo "  <h6 class='u-text u-text-default u-text-2'>Biography:</h6>";
              echo "<div class='gfg'><p class='u-text u-text-default u-text-3'>$row[0]<br></div>";
          ...
          <div class="u-layout">
            <div class="u-layout-row">
              <div class="u-container-style u-layout-cell u-size-30 u-layout-cell-1">
                <div class="u-container-layout u-container-layout-2"><span class="u-file-icon u-icon u-icon-1" data-href="Composer_profile.php"><img src="images/545680.png" alt=""></span>
                  <h3 class="u-text u-text-default u-text-4">
                    ...
                    //need to add composer website!
                    $composerID = $_GET['id'];
                    $SQLstring = "select name, birth_death_date,link_1 from composer where id = $composerID ";
                    $queryResult = @mysqli_query($DBConnect , $SQLstring)
                    Or die ("<p>Unable to query the table.</p>"."<p>Error code ".mysqli_errno($DBConnect). ": ".mysqli_error($DBConnect))."</p>";
                    $row = mysqli_fetch_row($queryResult);

                    echo "<a name='_6r2m07tp7zgn'></a>
                    <span lang='EN' style='line-height: 115%; font-family: Arial, sans-serif;'>$row[0]</span><!--EndFragment-->
                    </h3><p class='u-custom-font u-heading-font u-text u-text-default u-text-5'>$row[1]</p>";

                    if(isset($row[2])){
                    echo "<a href='$row[2]' class='u-border-2 u-border-black u-btn u-btn-rectangle u-button-style u-none u-btn-1'>Composer website</a>"; 
                                  }
              ...
              <!--<div class="u-container-style u-image u-layout-cell u-size-30 u-image-1" data-image-width="421" data-image-height="236">-->
    ...
    <section class="u-align-center u-clearfix u-section-2" id="sec-4a6c">
      <div class="u-clearfix u-sheet u-sheet-1">
...
$composerID = $_GET['id'];
//echo $composerID; 
$SQLstring = "select name, year_1, duration, recording_link_1, score_link_1 , composer_id from work where composer_id = $composerID  " ;
$queryResult = @mysqli_query($DBConnect , $SQLstring)
Or die ("<p>Unable to query the table.</p>"."<p>Error code ".mysqli_errno($DBConnect). ": ".mysqli_error($DBConnect))."</p>";
...
<td class='u-table-cell'>Name of a piece</td>
<td class='u-table-cell'>Year</td>
<td class='u-table-cell'>Duration</td>
<td class='u-table-cell'>Recoding link</td>
<td class='u-table-cell'>Score link&nbsp;</td>
</tr><tr style='height: 65px;'>";

$row = mysqli_fetch_row($queryResult);

while ($row) {
echo "<td class='u-table-cell'>$row[0]</td>";
echo "<td class='u-table-cell'>$row[1]</td>";
echo "<td class='u-table-cell'>$row[2](mins)</td>"; 
echo "<td class='u-table-cell'><a class='u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-palette-1-base u-btn-1' href=$row[3] target='_blank'> Link</a></td>";

echo "<td class='u-table-cell'><a class='u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-palette-1-base u-btn-2' href=$row[4] target='_blank'>Link</a></td></tr>";
