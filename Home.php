...
<html style="font-size: 16px;" lang="en"><head>
    ...
    <meta charset="utf-8">
    <meta name="keywords" content="WELCOME, Olivia Tran">
...
<link rel="stylesheet" href="Home.css" media="screen">
  ...
  <body class="u-body u-xl-mode" data-lang="en"><header class="u-clearfix u-header u-header" id="sec-eb68"><div class="u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-align-center u-clearfix u-image u-shading u-section-1" src="" data-image-width="1280" data-image-height="960" id="sec-3e5c">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <?php
              ...
              $SQLstring = "SELECT name, id FROM composer order by RAND() LIMIT 1";
              $queryResult = @mysqli_query($DBConnect , $SQLstring);
              $row = mysqli_fetch_row($queryResult);

                echo "<h1> <i>Composer spotlight: $row[0]</i></h1>";
                $id = $row[1];
                        echo "<a href='Profile_detail.php?id=$id' class='u-border-none u-btn u-button-style u-palette-4-dark-1 u-btn-1'>CHECK THE COMPOSER DETAIL</a>";
